...
class ContentModel {
  ...
  final String taskTargetId;
  final String projectName;
  final String? promptSpeechTime;         // Minimum recording time requirement
  ...
  factory ContentModel.fromJson(Map<String, dynamic> json) {
    return ContentModel(
      ...
      taskTargetId: json['taskTargetId'] ?? '',
      projectName: json['projectName'] ?? '',
      promptSpeechTime: json['promptSpeechTime'],
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'taskTargetId': taskTargetId,
      'projectName': projectName,
      'promptSpeechTime': promptSpeechTime,
    };
  }
}