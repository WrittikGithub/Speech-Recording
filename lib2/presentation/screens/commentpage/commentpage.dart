...
class _CommentSheetState extends State<CommentSheet> {
  ...
  void _fetchComments() {
    context.read<FetchCommentBloc>().add(FetchCommentInitialEvent(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                Expanded(
                  child: BlocBuilder<FetchCommentBloc, FetchCommentState>(
                    builder: (context, state) {
                      if (state is FetchCommmentLoadingState) {
                        return Center(
                          child: LoadingAnimationWidget.staggeredDotsWave(
                              color: Appcolors.kpurplelightColor, size: 30),
                        );
                      }
                      if (state is FetchCommentErrorState) {
                        return Center(
                          child: Column(
      ...
      bottomSheet: Container(
        color: Colors.white,
        child: SafeArea(
          child: BlocConsumer<SaveCommentBloc, SaveCommentState>(
            listener: (context, state) {
              if (state is SaveCommentSuccessState) {
              ...
              } else if (state is SaveCommentErrorState) {
                CustomSnackBar.show(
                    context: context,
                    title: 'Error',
              ...
              return Container(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 10),
                    state is SaveCommentLoadingState
                        ? const SizedBox(
                            width: 48,
                            height: 48,
                            child: Padding(
                        ...
                        : IconButton(
                            ...
                            onPressed: () {
                              ...
                              context.read<SaveCommentBloc>().add(
                                  SaveCommentButtonClickingEvent(
