...
class FilterBottomSheetCompletedTask extends StatefulWidget {
  const FilterBottomSheetCompletedTask({super.key});

  @override
  State<FilterBottomSheetCompletedTask> createState() =>
      _FilterBottomSheetCompletedTaskState();
}

class _FilterBottomSheetCompletedTaskState
    extends State<FilterBottomSheetCompletedTask> {
  String? selectedLanguage;
  String? selectedStatus;

  final List<String> statuses = ['REJECTED', 'COMPLETED', 'APPROVED'];
          ...
          Row(
            children: [
              ...
              Expanded(
                ...
                onPressed: () {
                  context.read<CompletedTaskBloc>().add(
                        CompletedTaskFilterEvent(
